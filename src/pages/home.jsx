...
<footer id="Contact" class=" text-white bg-[#a32104] py-8">
    <div class="container mx-auto px-4">
        <div class=" flex items-center   justify-between  md:grid-cols-2 lg:grid-cols-4 ">
            <div className="flex t -mt-8 -p-4 flex-col items-center ">
            <img src={logow} className="w-40 mb-2 " alt="" />
                <p className="max-w-lg text-[15px] -mt-8 mx-auto">SAGE HOSPITALITY GROUP</p>
            </div>
          
            <div className=" mb-4 ">
                <h4 class="text-lg font-bold mt-[8px] mb-3">Contact Us</h4>
                <ul class="space-y-4">
                    <li><a href="#" class="hover:text-gray-300">sagehospitaty@gmail.com</a></li>
                    <li><a href="#" class="hover:text-gray-300">+1-555-123-4567</a></li>
                </ul>
            </div>
           
        </div>
        <div class="flex  space-x-4 sm:justify-center  ">
         <a href="#" class="group w-9 h-9 rounded-full border border-gray-300 flex justify-center items-center transition-all duration-500 hover:bg-white">
           <svg class="text-white transition-all duration-500  group-hover:text-black" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
             <g id="Social Media">
         ...
         <a href="#" class="group w-9 h-9 rounded-full border border-gray-300 flex justify-center hover:bg-white items-center transition-all hover:bg-white duration-500 ">
           <svg class="w-[1.25rem] h-[1.125rem] text-text-white transition-all duration-500  group-hover:text-pink-600" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
         ...
         <a href="#" class="group w-9 h-9 rounded-full border border-gray-300 flex justify-center items-center transition-all duration-500  hover:bg-white">
           <svg class="w-[1rem] h-[1rem] text-text-white transition-all duration-500  group-hover:text-blue-400" viewBox="0 0 13 12" fill="none" xmlns="http://www.w3.org/2000/svg">
         ...
         <a href="#" class="group w-9 h-9 rounded-full border border-gray-300 flex justify-center items-center transition-all duration-500 hover:bg-white">
           <svg class="w-[1.25rem] h-[0.875rem] text-white transition-all duration-500  group-hover:text-red-600" viewBox="0 0 16 12" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <span class="block text-sm text-center mt-6 text-w">© 2025 SAGE HOSPITALY GROUB™. All Rights Reserved.
